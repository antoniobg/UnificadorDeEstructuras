// $ANTLR : "LexerECR.g" -> "LexerECR.java"$
...
public class LexerECR extends antlr.CharScanner implements LexerECRTokenTypes, TokenStream
 {
public LexerECR(InputStream in) {
	this(new ByteBuffer(in));
}
public LexerECR(Reader in) {
	this(new CharBuffer(in));
}
public LexerECR(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public LexerECR(LexerSharedInputState state) {
	super(state);
