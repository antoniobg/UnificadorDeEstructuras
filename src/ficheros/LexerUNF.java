// $ANTLR : "LexerUNF.g" -> "LexerUNF.java"$
...
public class LexerUNF extends antlr.CharScanner implements LexerUNFTokenTypes, TokenStream
 {
public LexerUNF(InputStream in) {
	this(new ByteBuffer(in));
}
public LexerUNF(Reader in) {
	this(new CharBuffer(in));
}
public LexerUNF(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public LexerUNF(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("Unifica", this), new Integer(6));
}
...
tryAgain:
	...
	public final void mASP(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ASP;
		int _saveIndex;
